...
class Inspection(APIView):
    ...
    def delete(self, request, id, format=None):
        ...
        try:
            inspection = PropertyInspection.objects.get(property=property, date_time=date_time)
            inspection.delete()
            serializer = PropertyInspectionSerializer(inspection)
            return Response(serializer.data)
